<?php
	...
	if($_GET['action']=="list" ){
		...
		$idc = $_GET['idc'];
		$query="SELECT p.idp, p.nombrep, p.descripcionp, p.preciop, p.tamanhop, p.pesop, p.imagenp, p.materialp, p.idpr, p.idc, pr.nombrepr, pr.apellidospr FROM productos p, proveedor pr WHERE p.idc='$idc' and p.idpr=pr.idpr ORDER BY p.idp";
